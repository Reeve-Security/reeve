...
emits JCS-canonical bytes per schema-rule, updates the matching CycloneDX
...
FIXTURES_DIR = pathlib.Path(__file__).resolve().parents[1] / "schema" / "fixtures"
ROOT = FIXTURES_DIR / "aibom-v0.1.0"
SENSITIVE_DATA_ROOT = FIXTURES_DIR / "sensitive-data-report"
SECRET_RULE_PACK_ROOT = FIXTURES_DIR / "secret-rule-pack"
...
def create_fixture_28():
    ...
    manifest = {
        ...
        "notes": (
            ...
            "the equality check. This is the core invariant from schema-rule's "
