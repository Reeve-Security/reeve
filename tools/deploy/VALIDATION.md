...
The repeatable Phase 1 path lives in `tools/lab/test-vps/`. It uses
Terraform/OpenTofu for a disposable Hetzner Ubuntu VPS and Ansible to
run the real curl-install template against system paths.
