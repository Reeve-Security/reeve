...
mod tests {
    ...
    #[test]
    fn fixture_corpus_matches_manifests() {
        let repo = PathBuf::from(env!("CARGO_MANIFEST_DIR")).join("../..");
        let outcomes = validate_fixture_tree(
            repo.join("schema/examples/fixtures"),
    ...
    #[test]
    fn v0_2_0_fixture_corpus_matches_manifests() {
        let repo = PathBuf::from(env!("CARGO_MANIFEST_DIR")).join("../..");
        let outcomes = validate_fixture_tree(
            repo.join("schema/examples/fixtures-v0.2.0"),
    ...
    #[test]
    fn v0_3_0_fixture_corpus_matches_manifests() {
        let repo = PathBuf::from(env!("CARGO_MANIFEST_DIR")).join("../..");
        let outcomes = validate_fixture_tree(
            repo.join("schema/examples/fixtures-v0.3.0"),
