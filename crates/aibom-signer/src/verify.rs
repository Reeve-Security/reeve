...
/// Run Reeve's structural Sigstore-bundle pre-screen.
///
/// This checks bundle shape, fixture rejection, subject/allowlist facts, and
/// error flags Reeve records for fixtures. It does not cryptographically
/// validate Fulcio chains, DSSE signatures, Rekor inclusion proofs, or TUF
/// metadata. Use `cosign verify-blob` for public Sigstore proof.
